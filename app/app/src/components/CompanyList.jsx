...
//         setNewCompany({ id: "", name: "" }); // לארגן מחדש הכניסות
//         fetchCompanies();
//       })
//       .catch((error) => {
//         if (error.response) {
//           // בדוק האם התקבלה הודעת שגיאה עבור קיום חברה
//           alert(error.response.data); // הצג את הודעת השגיאה
//         } else {
...
//               style={{ marginBottom: "10px", marginRight: "10px" }}
//             />
//             <Button variant="contained" color="success" onClick={addCompany} style={{ marginRight: "10px" }}>
//               Add Company
//             </Button>
//             <Button variant="contained" color="primary" onClick={updateCompany} style={{ marginRight: "10px" }}>
//               Update Company
//             </Button>
//           </CardContent>
//         </Card>
...
//         />
//         <Button variant="contained" color="info" onClick={searchCompanyById} style={{ marginRight: "10px" }}>
//           Search by ID
//         </Button>
//         <TextField
...
//           style={{ marginBottom: "10px" }}
//         />
//         <Button variant="contained" color="info" onClick={searchCompanyByName} style={{ marginRight: "10px" }}>
//           Search by Name
//         </Button>
//         <Button variant="contained" color="error" onClick={deleteCompany} style={{ marginLeft: "10px" }}>
//           Delete Company
//         </Button>
