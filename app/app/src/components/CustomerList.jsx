...
//               style={{ marginBottom: "10px", marginRight: "10px" }}
//             />
//             <Button variant="contained" color="success" onClick={addCustomer} style={{ marginRight: "10px" }}>
//               Add Customer
//             </Button>
//             <Button variant="contained" color="primary" onClick={updateCustomer} style={{ marginRight: "10px" }}>
//               Update Customer
//             </Button>
//           </CardContent>
//         </Card>
...
//         />
//         <Button variant="contained" color="info" onClick={searchCustomer} style={{ marginRight: "10px" }}>
//           Search
//         </Button>
//         <Button variant="contained" color="error" onClick={deleteCustomer} style={{ marginLeft: "10px" }}>
//           Delete Customer
//         </Button>
